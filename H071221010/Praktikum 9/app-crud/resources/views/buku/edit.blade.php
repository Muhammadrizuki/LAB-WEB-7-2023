...
<form action='{{ url('buku/'.$data->idbuku) }}' method='post'>
@csrf 
@method('PUT')
<div class="p-5 rounded shadow-sm" style="margin-top: 60px; background-color: rgb(185, 164, 205)">
    <div class="mb-3 row">
        <h2 class="fw-bold">Edit Detail Buku</h2>
    </div>
    <div class="mb-3 row">
