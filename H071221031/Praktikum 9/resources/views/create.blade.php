...
<head>
    ...
    <title>Praktikum 9 - H071221031</title>
    ...
    <div class="container">
        ...
        <form class="row g-3" action="{{ route('toko.store') }}" method="POST">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="nama" class="form-control" placeholder="Item Name">
            </div>
            <div class="col-md-6">
                <label class="form-label">Price</label>
                <input type="text" name="harga" class="form-control" placeholder="Item Price">
            </div>
            <div class="col-12 mt-4">
                <label class="form-label">Album Types</label>
                <select name="jenis" class="form-select">
                    <option value="">Select The Album Types</option>
            ...
            <div class="col-12">
                ...
                <textarea type="text" name="deskripsi" class="form-control" placeholder="Item Description"></textarea>
            </div>
            <div class="col-12">
