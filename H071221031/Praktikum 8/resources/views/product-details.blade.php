...
@section('content')
    ...
    <div class="container">
        @foreach ($productdetails as $item)
            <div class="row">
                <div class="col-md-5">
                    <img src="https://awsimages.detik.net.id/community/media/visual/2021/06/07/go-yoon-jung-1_43.jpeg?w=1200" alt="Product Image"
                        class="img-fluid">
                </div>
                <div class="col-md-7">
        ...
        <div class="row">
            @foreach ($recommendations as $item)
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="https://awsimages.detik.net.id/community/media/visual/2021/06/07/go-yoon-jung-1_43.jpeg?w=1200"
