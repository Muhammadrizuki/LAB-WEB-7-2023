            ...
            <div class="col-xl-10">
                ...
                <div class="single-job-items mb-30">
                    ...
                    <div class="items-link items-link2 f-right">
                        <a href="/detailJob/{{$job->id}}">Detail</a>
                    </div>
                </div>
            @endforeach
        </div>
...
<div class="apply-process-area apply-bg pt-150 pb-150" data-background="{{asset('landingPage')}}/assets/img/gallery/how-applybg.png">
    <div class="container">
        <!-- Section Tittle -->
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="testimonial-caption ">
                            ...
                            <div class="testimonial-founder  ">
                                <div class="founder-img mb-30">
                                    <img src="{{asset('landingPage')}}/assets/img/testmonial/testimonial-founder.png" alt="">
